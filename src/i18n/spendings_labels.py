...
def get_spendings_callback_labels(lang="en"):
    all_labels = {
        "en": {
            ...
            "budget_exceeding": "Exceeding current monthly budget by ",
            "budget_remaining": "Remaining monthly budget of",
            "budget_fully_allocated": "Budget Fully Allocated",
        ...
        "tr": {
            ...
            "budget_exceeding": "Aylık bütçenizi aşan harcama",
            "budget_remaining": "Kalan aylık bütçe",
            "budget_fully_allocated": "Bütçe Tamamen Dağıtıldı",
